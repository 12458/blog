...
description: "What if instead of returning 404 to credential scanners, you gave them what they wanted... very slowly?"
---
...
- [**`ReadableStream`**](https://developers.cloudflare.com/workers/runtime-apis/streams/readablestream/) - the response body. Its `start(controller)` callback can be async, which is basically the entire trick
