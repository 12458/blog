...
pubDate: 2025-07-05T23:05:04+00:00
...
import Mermaid from '@/components/MermaidDiagram.astro';
import vaultwarden from '@/assets/images/vaultwarden.png';

<Picture src={vaultwarden} formats={['avif', 'webp']} alt="Vaultwarden" />
